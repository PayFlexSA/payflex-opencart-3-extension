...
This extension integrates PayFlex's "Buy Now, Pay Later" payment solution with OpenCart 3, allowing customers to split their purchases into interest-free installments.


## Installation
1. **Download and Extract**
   - Download the latest module archive from the releases page
2. **Install via the Extension installer**
